...
return(
    <>
        <Row className="py-4">
          ...
          {myId && <Button onClick={handleShow} > <i className="fa-solid fa-plus mr-3"></i></Button>} 
        ...
        <Modal.Body>
          ...
          <Form.Control type="text" placeholder="Role" value={postXp.role}
                onChange={(e) =>
                  setPostXp({
                    ...postXp,
                    role: e.target.value,
          ...
          <Form.Control type="text" placeholder="Company" value={postXp.company}
                onChange={(e) =>
                  setPostXp({
                    ...postXp,
        ...
        <Form.Group className="mb-3" >
          ...
          <Form.Control type="date" placeholder="Start Date" value={postXp.startDate}
                onChange={(e) =>
                  setPostXp({
                    ...postXp,
          ...
          <Form.Control type="text" placeholder="Description" value={postXp.description}
                onChange={(e) =>
                  setPostXp({
                    ...postXp,
        ...
        <Form.Group className="mb-3" >
          ...
          <Form.Control type="text" placeholder="Area" value={postXp.area}
                onChange={(e) =>
                  setPostXp({
                    ...postXp,
                    area: e.target.value,
        ...
        <div className="pl-5">
          <Image src={experience.image} className="mr-2 image-experience" />
        ...
        <div className="pl-1 text-left">
          ...
          <p className="mb-0">{experience.startDate} {experience.endDate}</p>
          <p className="mb-0">{experience.area}</p>
          {myId &&  <Button className='mr-2' onClick={() => settingId(experience._id)}> <i className="fa-solid fa-pen"></i></Button> }
         {myId &&  <Button className='mr-2' onClick={() => deleteXp(experience._id)}>Delete</Button>}
        </div>
        <div></div>
        </Row>
        <hr className="my-3" />
